...
//    private static final double STOP_LOSS_MODIFER       = 0.5;
    ...
    private Direction getDirection() {
        return this.getMarketConditions().getIndication(Direction.ID, Currencies.BTC);
    }

    private MACDZeroCross getZeroCross() {
        return this.getMarketConditions().getIndication(MACDZeroCross.ID, Currencies.BTC);
    }

    private MACDSignalCross getSignalCross() {
        return this.getMarketConditions().getIndication(MACDSignalCross.ID, Currencies.BTC);
    }
